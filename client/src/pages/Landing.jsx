...
const Landing = () => {
  return (
    <div className="min-h-[100dvh] bg-gradient-to-tr from-sky-400 via-sky-200 to-indigo-300 text-slate-800 font-sans flex flex-col justify-between items-center relative overflow-y-auto overflow-x-hidden selection:bg-sky-500 selection:text-white">
      {/* Background Soft Glows matching Login */}
      ...
      {/* Header */}
      <header className="max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between relative z-10 shrink-0">
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-tr from-sky-500 to-cyan-400 flex items-center justify-center shadow-lg shadow-sky-500/30">
            <MessageCircle className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
          </div>
          <span className="text-xl sm:text-2xl font-black tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-sky-800 to-blue-900">
            RB-CHAT
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Link
            to="/login"
            className="px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base font-black text-sky-900 hover:text-sky-950 transition"
          >
            Login
          </Link>
          <Link
            to="/register"
            className="px-4 py-2.5 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-sky-500 via-cyan-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-sm sm:text-base font-black text-white transition shadow-xl shadow-sky-500/30"
          >
            Register
          </Link>
        </div>
      ...
      {/* Hero Section - Perfectly Centered with full mobile scroll support */}
      <main className="max-w-5xl mx-auto px-6 py-8 sm:py-12 w-full text-center relative z-10 flex flex-col items-center justify-center my-auto">
        <div className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 rounded-full bg-white/70 border border-sky-200/80 text-sky-800 text-xs font-bold uppercase tracking-wider mb-6 sm:mb-8 shadow-sm backdrop-blur-md">
          <Sparkles className="w-4 h-4 text-sky-600" /> Next-Gen Real-Time Messenger
        </div>

        <h1 className="text-4xl sm:text-7xl font-black tracking-tight leading-[1.1] mb-4 sm:mb-6 text-slate-900 max-w-4xl mx-auto text-center">
        ...
        <p className="text-sm sm:text-xl text-slate-700 max-w-2xl mx-auto mb-8 sm:mb-12 font-semibold leading-relaxed text-center">
          Experience lightning-fast messaging, secure communication, and a clean interface built for seamless daily conversations.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 sm:mb-20 w-full max-w-md mx-auto">
          <Link
            to="/register"
        ...
        {/* Bottom Feature Grid */}
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 text-left pt-8 sm:pt-12 border-t border-sky-200/60 w-full max-w-5xl">
          <div className="p-5 sm:p-6 rounded-2xl bg-white/80 border border-sky-100 shadow-lg shadow-sky-500/5 backdrop-blur-md">
      ...
      {/* Footer */}
      <footer className="max-w-7xl mx-auto w-full px-6 py-6 border-t border-sky-200/60 text-center text-xs text-sky-900 font-bold relative z-10 bg-white/30 backdrop-blur-sm shrink-0">
